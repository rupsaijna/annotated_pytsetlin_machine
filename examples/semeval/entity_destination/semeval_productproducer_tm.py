#identify if a sentence contains product-producer relationship
import sys
...
clause_file='productproducer_clause_details'+timestr+'.txt'
feature_file='productproducer_feature_details'+timestr+'.txt'
meta_file='productproducer_meta_details'+timestr+'.txt'
...
fo.write('semeval_productproducer_tm.py\n')
