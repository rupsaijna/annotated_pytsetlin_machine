#identify if a sentence contains Member-Collection relationship
import sys
...
clause_file='membercollection_clause_details'+timestr+'.txt'
feature_file='membercollection_feature_details'+timestr+'.txt'
meta_file='membercollection_meta_details'+timestr+'.txt'

RUNS=300

inp='../data/training_member_collection.csv'
...
fo=open(meta_file,'w')
fo.write('SEMEVAL 2010 task 8. Sentences classified as Member-Collection/Non-Member-Collection.\n')
fo.write('bigrams and unigrams. stopwords not removed. punctuation removed.\n')
fo.write('semeval_membercollection_tm.py\n')
