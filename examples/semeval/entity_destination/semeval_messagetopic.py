#identify if a sentence contains Message-Topic relationship
import sys
...
clause_file='messagetopic_clause_details'+timestr+'.txt'
feature_file='messagetopic_feature_details'+timestr+'.txt'
meta_file='messagetopic_meta_details'+timestr+'.txt'
...
fo=open(meta_file,'w')
fo.write('SEMEVAL 2010 task 8. Sentences classified as Message-Topic/Non-Message-Topic.\n')
fo.write('bigrams and unigrams. stopwords not removed. punctuation removed.\n')
fo.write('semeval_messagetopic_tm.py\n')
