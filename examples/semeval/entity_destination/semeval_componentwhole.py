#identify if a sentence contains Component-Whole relationship
import sys
...
clause_file='componentwhole_clause_details'+timestr+'.txt'
feature_file='componentwhole_feature_details'+timestr+'.txt'
meta_file='componentwhole_meta_details'+timestr+'.txt'

RUNS=300

inp='../data/training_component_whole.csv'
...
fo=open(meta_file,'w')
fo.write('SEMEVAL 2010 task 8. Sentences classified as  Component-Whole/Non-Component-Whole.\n')
fo.write('bigrams and unigrams. stopwords not removed. punctuation removed.\n')
fo.write('semeval_componentwhole_tm.py\n')
