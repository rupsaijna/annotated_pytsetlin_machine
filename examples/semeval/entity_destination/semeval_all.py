#identify if a sentence contains all relationships
import sys
...
clause_file='all_clause_details'+timestr+'.txt'
...
fo=open(meta_file,'w')
fo.write('SEMEVAL 2010 task 8. Sentences classified as as classes.\n')
fo.write('bigrams and unigrams. stopwords not removed. punctuation removed.\n')
fo.write('semeval_mall_tm.py\n')
