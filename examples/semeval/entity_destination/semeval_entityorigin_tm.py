#identify if a sentence contains  Entity-Origin relationship
import sys
...
clause_file='entityorigin_clause_details'+timestr+'.txt'
feature_file='entityorigin_feature_details'+timestr+'.txt'
meta_file='entityorigin_meta_details'+timestr+'.txt'

RUNS=300

inp='../data/training_entity_origin.csv'
...
fo=open(meta_file,'w')
fo.write('SEMEVAL 2010 task 8. Sentences classified as  Entity-Origin/Non-Entity-Origin.\n')
fo.write('bigrams and unigrams. stopwords not removed. punctuation removed.\n')
fo.write('semeval_entityorigin_tm.py\n')
