#identify if a sentence contains instrument-agency relationship
import sys
...
clause_file='instrumentagency_clause_details'+timestr+'.txt'
feature_file='instrumentagency_feature_details'+timestr+'.txt'
meta_file='instrumentagency_meta_details'+timestr+'.txt'
...
fo=open(meta_file,'w')
fo.write('SEMEVAL 2010 task 8. Sentences classified as Instrument-Agency/Non-Instrument-Agency.\n')
fo.write('bigrams and unigrams. stopwords not removed. punctuation removed.\n')
fo.write('semeval_instrumentagency_tm.py\n')
