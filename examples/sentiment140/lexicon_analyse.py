...
for d in newdict:
	...
	cntdict[d]['text_positive_features_cnt']=len(set(newdict[d]['in_text']).union(set(newdict[d]['in_positive_features'])))
	cntdict[d]['text_negative_features_cnt']=len(set(newdict[d]['in_text']).union(set(newdict[d]['in_negative_features'])))
